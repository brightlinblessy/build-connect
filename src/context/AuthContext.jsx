...
import { getUserProfile, completeRedirectSignIn } from '../firebase/auth'
...
export function AuthProvider({ children }) {
  ...
  useEffect(() => {
    // If the person just came back from a Google/Facebook redirect
    // sign-in (see loginWithGoogle/loginWithFacebook's popup-blocked
    // fallback), finish creating their profile before/alongside the
    // normal auth-state listener below.
