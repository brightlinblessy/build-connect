...
// Only three account types can be created from the public Register screen.
        ...
        <div className="w-full max-w-md">
          ...
          {accountType === 'admin' && (
            <p className="text-xs text-amber-700 bg-amber-50 rounded-lg px-3 py-2 mt-3">
              Admin accounts have full platform access. Only create one if you manage BuildConnect.
            </p>
          )}
