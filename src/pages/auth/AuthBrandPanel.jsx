...
export default function AuthBrandPanel() {
  ...
  const statItems = [
    { label: 'Projects Posted', value: stats?.projects ?? '—' },
    { label: 'Registered Engineers', value: stats?.engineers ?? '—' },
    { label: 'Registered Clients', value: stats?.clients ?? '—' },
    ...
    <div className="relative hidden lg:flex flex-col justify-between w-[46%] shrink-0 bg-navy-900 text-white px-12 py-12 overflow-hidden">
      ...
      <div className="relative">
        ...
        <p className="text-slate-300 text-sm mt-4 max-w-sm">
          Clients, engineers, architects, and contractors all work from one connected
